...
Note: You just need to implement the inorderTraversal() function. Input and output have been handled in the driver code.
...
class Main {
	...
	public static void inorder (String[] args) throws IOException{
